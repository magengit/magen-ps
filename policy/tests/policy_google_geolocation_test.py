...
class TestGoogleGeolocation(unittest.TestCase):
    ...
    def test_Geocoding(self):
        ...
        if key:
           ...
           geocode_result = gmaps.geocode('170 West Tasman Dr., San Jose, CA 95134')
           ...
           self.assertEqual(geocode_result[0]['geometry']['location']['lat'], 37.4084383)
           self.assertEqual(geocode_result[0]['geometry']['location']['lng'], -121.9539644)
    ...
    def test_GeocodingZip(self):
        ...
        if key:
           ...
           self.assertEqual(geocode_result[0]['formatted_address'], "San Jose, CA 95134, USA")
           self.assertEqual(geocode_result[0]['geometry']['location']['lat'], 37.4308503)
           self.assertEqual(geocode_result[0]['geometry']['location']['lng'], -121.9529992)
        else:
           print("No Google Maps API KEY FOUND")
    ...
    def test_GeocodingCity(self):
        ...
        if key:
           ...
           self.assertEqual(geocode_result[0]['formatted_address'], "San Jose, CA, USA")
           self.assertEqual(geocode_result[0]['geometry']['location']['lat'], 37.3382082)
           self.assertEqual(geocode_result[0]['geometry']['location']['lng'], -121.8863286)
        else:
           print("No Google Maps API KEY found")    
    ...
    def test_ReverseGeocoding(self):
        ...
        if key:
           ...
           reverse_geocode_result = gmaps.reverse_geocode((37.4083511, -121.954079))
    ...
    def test_ReverseGeocodingFilter(self):
        ...
        if key:
           gmaps = googlemaps.Client(key)
           # Look up an address with reverse geocoding
           reverse_geocode_result = gmaps.reverse_geocode((37.4083511, -121.954079), result_type=['locality'])
           self.assertIsNotNone(reverse_geocode_result)
           self.assertEqual(reverse_geocode_result[0]['formatted_address'],
                            "San Jose, CA, USA") 
        else:
    ...
    def test_PlacesGeocoding(self):
        ...
        if key:
           ...
           self.assertEqual(place_geocoding_result["result"]['formatted_address'],
                            "San Jose, CA, USA")
        else:
            print("No Google Maps API KEY found")
    ...
    def test_GeofencingAlgo(self):
        ...
        if key:
           ...
           reverse_geocode_result = gmaps.reverse_geocode((37.400281, -121.939455), result_type=types[0])
